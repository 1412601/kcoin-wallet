...
export const MESSAGE_GET_COIN = "MESSAGE_GET_COIN";
export const MESSAGE_EMPTY_BALANCE = "MESSAGE_EMPTY_BALANCE";
export const MESSAGE_NEW_TRANS = "MESSAGE_NEW_TRANS";
export const MESSAGE_CONFIRM_TRANS = "MESSAGE_CONFIRM_TRANS";
